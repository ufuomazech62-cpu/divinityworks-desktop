...
const DEFAULT_TAG_DEFINITIONS: TagDefinition[] = [
  ...
  { tag: 'customer', type: 'relationship', applicability: 'both', noteEffect: 'create', description: 'Paying customers', example: 'We\'re seeing great results with Divinity. Can we discuss expanding to more teams?' },
  ...
  { tag: 'community', type: 'relationship', applicability: 'both', noteEffect: 'create', description: 'Peers, YC batchmates, or open source contributors with direct interaction', example: 'Love what you\'re building with Divinity. Here\'s a bug I found...' },
