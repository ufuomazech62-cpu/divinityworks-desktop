...
- **topic: meeting** (CREATE) — A calendar invite or scheduling email for a real meeting with a **named person** you have a relationship with: an investor, customer, partner, candidate, advisor, team member. Examples: "Invitation: Zoom: Divinity Labs <> Dalton Caldwell", "YC between Peer Richelsen and Arjun", "Divinity <> Smash Capital". The key signal is a specific person or company in the subject/body.
