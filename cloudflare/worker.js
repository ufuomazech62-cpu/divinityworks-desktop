...
async function handle(request) {
  ...
  const css = `/*
  Divinity Works — landing v2. Sharp, sleek, smooth.
...
.cap:hover { border-color: var(--border-strong); }
.cap__label {
  font-size: 11px; font-weight: 500; letter-spacing: 0.1em;
  text-transform: uppercase; color: var(--muted-soft); margin-bottom: 10px;
}
.cap__title { font-size: 15px; font-weight: 600; letter-spacing: -0.02em; color: var(--text); margin-bottom: 6px; }
...
.os-card__name { font-size: 16px; font-weight: 600; letter-spacing: -0.02em; color: #fff; }
.os-card__meta { font-size: 12.5px; color: rgba(255,255,255,0.55); }
.download__platforms { margin-top: 28px; font-size: 12.5px; color: rgba(255,255,255,0.45); }
...
@media (max-width: 600px) {
  ...
  .section, .surfaces, .how, .why, .caps, .download { padding-top: 64px; padding-bottom: 64px; }
  .surfaces__grid, .how__grid, .caps__grid { grid-template-columns: 1fr; }
...
<head>
  ...
  <title>Divinity Works — Your AI, Already Knows Your Work</title>
  <meta name="description" content="Divinity is the AI coworker with a private memory of your work. Email, meetings, and tools flow in — then Divinity drafts, browses, codes, and acts across every app. Local-first. Bring your own model." />
  <meta property="og:title" content="Divinity Works — Your AI, Already Knows Your Work" />
  <meta property="og:description" content="One private memory of your work. Then Divinity drafts, browses, codes, and acts across every app. Local-first. Bring your own model." />
  ...
  <main>
    ...
    <section class="hero">
      <div class="hero__inner">
        <h1 class="hero__title">Your AI. Already knows your work.</h1>
        <p class="hero__lede">
          Email, meetings, and tools — indexed into one private memory. Then Divinity drafts, browses, codes, and acts across every app you use.
        </p>
        <div class="hero__cta">
          <a class="btn btn--primary" href="#download">Download</a>
          <a class="btn btn--ghost" href="#how">See the loop</a>
        </div>
        <p class="hero__note">Free during beta · Mac, Windows, Linux</p>
        ...
        <div class="hero__shot" role="img" aria-label="Divinity Works desktop app">
          <img
            ...
            alt="Divinity Works desktop app — agent workspace, copilot panel, and built-in tools"
    ...
    <section id="surfaces" class="surfaces">
      <div class="section__inner">
        ...
        <p class="section__lede">Email, browser, code, notes, meetings — wired into the same memory.</p>
        <div class="surfaces__grid">
          ...
          <article class="surface">
            ...
            <p class="surface__desc">A focused inbox with replies drafted before you open them.</p>
          </article>
          <article class="surface">
            <span class="surface__icon">
            ...
            <p class="surface__desc">An isolated browser the assistant drives. Log in only to what it should touch.</p>
          </article>
          <article class="surface">
            <span class="surface__icon">
            ...
            <p class="surface__desc">Parallel Claude Code or Codex agents, run with your full context.</p>
          </article>
          <article class="surface">
            <span class="surface__icon">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="22"/></svg>
            </span>
            <h3 class="surface__name">Meeting notes</h3>
            <p class="surface__desc">Local transcription of mic and speakers, summarized to Markdown.</p>
          </article>
          <article class="surface">
            <span class="surface__icon">
            ...
            <p class="surface__desc">Build your own surfaces with full tool access. Share them with anyone.</p>
          </article>
        </div>
      </div>
    </section>
    ...
    <section id="how" class="how">
      <div class="section__inner">
        ...
        <h2 class="section__title">Memory compounds. So does the work.</h2>
        <p class="section__lede">Most agents start cold. Divinity starts warm — every time.</p>
        <div class="how__grid">
          <article class="step">
            <span class="step__num">01</span>
            <h3 class="step__title">Captures</h3>
            <p class="step__desc">Email, meetings, and conversations flow into a private memory.</p>
          </article>
          <article class="step">
            <span class="step__num">02</span>
            <h3 class="step__title">Recalls</h3>
            <p class="step__desc">Ask anything. Pull from real context, not guesses.</p>
          </article>
          <article class="step">
            <span class="step__num">03</span>
            <h3 class="step__title">Acts</h3>
            <p class="step__desc">Drafts, emails, browser tasks, code — across your apps.</p>
          </article>
          <article class="step">
            <span class="step__num">04</span>
            <h3 class="step__title">Compounds</h3>
            <p class="step__desc">Learns your voice and workflow. Sharper every week.</p>
          </article>
        </div>
      </div>
    </section>
      ...
      <div class="section__inner">
        ...
        <div class="why__grid">
          <div class="why__item">
            ...
            <p class="why__text"><strong>Memory, not search.</strong><span>Context accumulates. Cold starts don't.</span></p>
          </div>
          <div class="why__item">
            <span class="why__check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></span>
            <p class="why__text"><strong>Acts, doesn't just answer.</strong><span>Drives a browser. Drafts email. Runs code.</span></p>
          </div>
          <div class="why__item">
            <span class="why__check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></span>
            <p class="why__text"><strong>Yours, on your disk.</strong><span>Plain Markdown. Read, edit, back up, delete.</span></p>
          </div>
          <div class="why__item">
            <span class="why__check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></span>
            <p class="why__text"><strong>Any model.</strong><span>Ollama, LM Studio, or your own API key.</span></p>
          </div>
          <div class="why__item">
            <span class="why__check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></span>
            <p class="why__text"><strong>Plug into anything.</strong><span>MCP-native. Composio for one-click integrations.</span></p>
          </div>
          <div class="why__item">
            <span class="why__check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></span>
            <p class="why__text"><strong>Works while you sleep.</strong><span>Set agents on events or schedules.</span></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="caps">
      <div class="section__inner">
        <p class="section__eyebrow">Foundations</p>
        <h2 class="section__title">Engineered to stay yours.</h2>
        <p class="section__lede">Four commitments that shape every part of Divinity.</p>
        <div class="caps__grid">
          <article class="cap">
            <p class="cap__label">Storage</p>
            <h3 class="cap__title">Local-first</h3>
            <p class="cap__desc">Notes, memory, conversations — plain Markdown on disk. No lock-in.</p>
          </article>
          <article class="cap">
            <p class="cap__label">Models</p>
            <h3 class="cap__title">Bring your own</h3>
            <p class="cap__desc">Run local via Ollama or LM Studio. Or bring your own API key. Swap anytime.</p>
          </article>
          <article class="cap">
            <p class="cap__label">Tools</p>
            <h3 class="cap__title">MCP-native</h3>
            <p class="cap__desc">Connect any MCP server. Or use Composio for hundreds of products in one click.</p>
          </article>
          <article class="cap">
            <p class="cap__label">Voice</p>
            <h3 class="cap__title">Speak &amp; listen</h3>
            <p class="cap__desc">Deepgram in. ElevenLabs out. Talk to Divinity. Let it talk back.</p>
          </article>
        </div>
      </div>
    </section>
    ...
    <section id="download" class="download">
      <div class="section__inner">
        ...
        <p class="section__lede">Divinity starts learning your work and getting things done from day one.</p>
        <div class="os-grid">
        ...
        <p class="download__platforms">v0.1.0 beta · Also available for Linux ARM64 and Intel Mac</p>
      </div>
    </section>
  </main>
