...
<head>
  ...
  <title>Divinity Works — An AI Coworker With a Real Memory of Your Work</title>
  <meta name="description" content="Divinity is a desktop AI coworker with a real memory of your work. It indexes your emails, meetings, files, and conversations into a living knowledge graph — then drafts, researches, and gets work done across your apps and the web." />
  <meta property="og:title" content="Divinity Works — An AI Coworker With a Real Memory of Your Work" />
  <meta property="og:description" content="A desktop AI coworker with a real memory of your work. Indexes your emails, meetings, files, and conversations — then drafts, researches, and gets work done across your apps and the web." />
  ...
  <main>
    ...
    <section class="hero">
      <div class="hero__inner">
        <h1 class="hero__title">An AI coworker with a real memory of your work.</h1>
        <p class="hero__lede">
          Divinity indexes your emails, meetings, files, and conversations into a living knowledge graph on your machine — then drafts, researches, and gets work done across your apps and the web.
        </p>
        <div class="hero__cta">
      ...
      <div class="section__inner">
        ...
        <div class="how__grid">
          ...
          <article class="step">
            ...
            <p class="step__desc">Picks up your voice, your projects, your workflow. Gets sharper the more you use it.</p>
          </article>
        </div>
      </div>
    </section>
